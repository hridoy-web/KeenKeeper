...
const Footer = () => {
    return (
        <div className='bg-[#244D3F]'>
            ...
            <div className='w-11/12 mx-auto flex flex-col items-center text-white text-center min-h-fit p-6 md:p-12 space-y-4 md:space-y-6'>
                ...
                <div className='flex flex-col lg:flex-row lg:justify-between w-full items-center'>
                    <p className='text-gray-400 text-sm md:text-base'>© 2026 KeenKeeper. All rights reserved.</p>

                    <div className='flex flex-wrap justify-center gap-4 md:gap-8 mt-3 lg:mt-0'>
