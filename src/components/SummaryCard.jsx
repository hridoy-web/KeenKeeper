    ...
    return (
        <>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-6 items-center justify-center text-center px-4'>
                ...
                <div className='bg-base-100 p-5 space-y-1 shadow-xl rounded-2xl cursor-pointer transition-all duration-500 hover:scale-105 border border-gray-200 '>
                    <h2 className='font-bold text-3xl'>10</h2>
                    <p className='text-gray-500 font-medium'>Total Friends</p>
                </div>
                <div className='bg-base-100 p-5 space-y-1 shadow-xl cursor-pointer transition-all duration-500 hover:scale-105 border border-gray-200 rounded-2xl '>
